...
function setup() {
  ...
  polygon_ball = Bodies.circle (50,200,20);
  World.add (world, polygon_ball);
  slingShot = new Slingshot(polygon_ball,{x:100,y:200});    
...
function draw() {
  ...
  imageMode(CENTER);
  image(polygon_img,polygon_ball.position.x,polygon_ball.position.y,40,40);  
  slingShot.display ();
...
function mouseDragged(){
  Matter.Body.setPosition(polygon_ball,{x:mouseX,y:mouseY});
}
